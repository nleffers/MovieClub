...
ActiveRecord::Schema[7.0].define(version: 2023_04_26_063300) do
  ...
  create_table "movie_reviews", force: :cascade do |t|
    ...
    t.index ["tmdb_movie_id"], name: "index_movie_reviews_on_tmdb_movie_id", unique: true
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "session_id"
    t.integer "tmdb_id"
    t.text "movie_watchlist", default: "--- []\n"
    t.text "bio"
